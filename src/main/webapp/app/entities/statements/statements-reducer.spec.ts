...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_STATEMENTS_LIST actions', async () => {
    ...
    it('dispatches FETCH_STATEMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_STATEMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_STATEMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_STATEMENTS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_STATEMENTS actions', async () => {
      const expectedActions = [
        {
